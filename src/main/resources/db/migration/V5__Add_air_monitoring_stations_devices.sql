...
CONSTRAINT fk_air_monitoring_stations_devices_to_air_monitoring_stations FOREIGN KEY ("AIR_MONITORING_STATION_ID") REFERENCES air_monitoring_stations,
CONSTRAINT fk_air_monitoring_stations_devices_to_devices FOREIGN KEY ("DEVICES_ID") REFERENCES devices
);